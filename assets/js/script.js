...
-------------------------------------------*/
   ...
   -------------------------------------------*/
    ...
    -------------------------------------------*/
    // if ($("#clock").length) {
    //     $('#clock').countdown('2026-11-30 20:30:00', function (event) {
    ...
    /*------------------------------------------
        = COUNTDOWN CLOCK XOCHITL
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2025-09-20 14:00:00', function (event) {
            var $this = $(this).html(event.strftime(''
                // + '<div class="box"><div><div class="time">%m</div> <span>Month</span> </div></div>'
                ...
                + '<div class="box"><div><div class="time">%M</div> <span>Miutos</span> </div></div>'
